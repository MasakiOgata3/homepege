...
const prompt = 'Clean, simple black and white illustration showing success and achievement. A person celebrating with raised arms at a desk with a computer showing a completed website. Minimalist line art style similar to modern tech illustrations. Black lines on white background only, no colors, no shading, very clean and professional.';
...
.then(buffer => {
  const filename = 'success-achievement.png';
